package dev.hanginggoose.nestdi.framework.test.scanning;

import dev.hanginggoose.nestdi.framework.scanning.ComponentScanner;
...
public class ComponentScannerTest {
    ...
    public void testComponentScannerFindsComponentsInPackage() {
        Set<Class<?>> components = scanner.scan("dev.hanginggoose.nestdi.demo");
    ...
    public void testComponentScannerDoesNotFindComponentsOutsidePackage() {
        Set<Class<?>> components = scanner.scan("dev.hanginggoose.nestdi.demo.domain");
    ...
    public void testComponentScannerFindsComponentsInMultiplePackages() {
        String[] packages = {
                "dev.hanginggoose.nestdi.demo.infrastructure.brand",
                "dev.hanginggoose.nestdi.demo.infrastructure.product"
        };
